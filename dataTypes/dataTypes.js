...
console.log(challenge.split(" ")); // Splits at spaces
...
console.log(companies.split(", ")); // Splits at commas and space

// 12 - Change '30 Days Of JavaScript' to '30 Days Of Python' using replace() method.
console.log(challenge.replace("JavaScript", "Python"));

// 13 - What is the character at index 15 in '30 Days Of JavaScript' string? Use charAt() method.
console.log(challenge.charAt(15)); // Returns the character at index 15

// 14 - What is the character code of J in '30 Days Of JavaScript' string using charCodeAt()
console.log(challenge.charCodeAt(0)); // Returns the character code of the first character ('J')
